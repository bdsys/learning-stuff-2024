...
console.log('It will also add the following new collections:');
console.log('prohibiteds -- Defines a list of strings');
...
function prohibitedsCreate (name, cb) {
  var prohibit = new Prohibiteds({ name: name });
       
  prohibit.save(function (err) {
    if (err) {
      cb(err, null);
      return;
    }
    console.log('New Prohibit: ' + prohibit);
    prohibitedses.push(prohibit)
    cb(null, prohibit);
  }   );
}
...
//
function createProhibits(cb) {
    async.series([
        function(callback) {
          prohibitedsCreate('fuck', callback);
        },
        function(callback) {
          prohibitedsCreate('cunt', callback);
        },
        function(callback) {
          prohibitedsCreate('shit', callback);
        },
        function(callback) {
          prohibitedsCreate('crap', callback);
        },
        function(callback) {
          prohibitedsCreate('tits', callback);
        },
        function(callback) {
          prohibitedsCreate('cock', callback);
        },
        function(callback) {
          prohibitedsCreate('ass', callback);
        },
        function(callback) {
          prohibitedsCreate('asshole', callback);
        },
        ],
        // optional callback
        cb);
